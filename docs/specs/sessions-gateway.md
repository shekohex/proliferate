...
| `sessions.coding_agent_session_id` | Coding harness lifecycle (`SessionRuntime`) | `SessionRuntime.ensureOpenCodeSession()` | Owner lease required through hub runtime gate | Durable DB + mirrored in-memory context |
