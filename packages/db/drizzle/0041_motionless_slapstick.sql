...
ALTER TABLE "sessions" ADD CONSTRAINT "sessions_task_linkage_check" CHECK ((kind != 'task'::text) OR (repo_id IS NOT NULL AND repo_baseline_id IS NOT NULL)) NOT VALID;--> statement-breakpoint
